                    ...
                    <?php
                        foreach($category as &$value){
                            echo "<div class = 'Catheader'>";
                                echo "<h2 style ='float:left;min-width:100px;'>".$value."</h2>".
                                "<a class = 'Morebtn' href = 'Genres.php?genre=".$value."&id=0'>More</a>";
                            echo "</div>";
                            $sql = "SELECT Film_id, Title, Rental_Rate, Length FROM film WHERE Category = '".$value."' LIMIT 8";
